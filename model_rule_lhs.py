...
if args.dataset == 'ICEWS14' or args.dataset == 'ICEWS14RR':
    ...
    if args.ICEWS15_rels == 'original' or args.dataset == 'ICEWS15RR':
        symmetry_rel = {224:224, 56:56, 111:111, 95:95, 174:174, 129:129, 105:105, 60:60, 128:128, 133:133, 127:127,
                        229:229, 144:144, 250:250, 11:11, 137:137, 168:168, 59:59, 208:208, 127:127, 172:172, 242:242}
...
train[:, 0], train[:, 2] = train_copy[:, 2], train_copy[:, 0]
...
def rank_entity_rules(instance,filter_out):
    ...
    dict_True = pickle.load(open('dict_' + str(args.dataset) + '_' + str(args.ICEWS15_rels) + '_True_lhs.pkl', 'rb'))
    dict_False = pickle.load(open('dict_' + str(args.dataset) + '_' + str(args.ICEWS15_rels) + '_False_lhs.pkl', 'rb'))
